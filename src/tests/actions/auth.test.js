...
describe('Pruebas en las acciones Auth', () => {
 ...
 test('startLogin correcto', async () => {
  ...
  Storage.prototype.setItem = jest.fn();
   ...
   await store.dispatch( startLogin('enzo@gmail.com', '123456') );
   ...
   expect( actions[0] ).toEqual({
     ...
     // token =  console.log(localStorage.setItem.mock.calls[0][1]);
 ...
 test('startlogin incorrecto', async () => {
    ...
    await store.dispatch( startLogin('enzo@gmail.com', '123458') );
    ...
    await store.dispatch( startLogin('enzo@gmail2.com', '123456') );
